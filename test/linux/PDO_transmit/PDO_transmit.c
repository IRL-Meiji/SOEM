       ...
       if ( ec_config_init(FALSE) > 0 )
      {
         ...
         if (ec_slave[0].state == EC_STATE_OPERATIONAL )
         {
            ...
            for(;;)
            {
               ...
               printf("Uint32: %X, Uint16: %X, Uint8: %X\r\n\r\n", uint32_Output, uint16_Output, uint8_Output);
               /*printf("IOmap[0x0000] = %X\r\n", uint32_Output & 0xFF);
               printf("IOmap[0x0001] = %X\r\n", (uint32_Output >> 8) & 0xFF);
               printf("IOmap[0x0002] = %X\r\n", (uint32_Output >> 16) & 0xFF);
               printf("IOmap[0x0003] = %X\r\n", (uint32_Output >> 24) & 0xFF);
               printf("IOmap[0x0004] = %X\r\n", uint16_Output & 0xFF);
               printf("IOmap[0x0005] = %X\r\n", (uint16_Output >> 8) & 0xFF);
               printf("IOmap[0x0006] = %X\r\n\r\n", uint8_Output);*/
